...
from tensorflow.keras.layers import (
    ...
    Input,
    SpatialDropout1D,
    MaxPooling1D,  # Import MaxPooling1D layer
)
...
def create(input_shape, num_outputs, output_activation="log_softmax", padding="causal", channel_dropout_rate=0):
    ...
    max_pool_1 = MaxPooling1D(pool_size=2, name="max_pool_1")(conv_1)  # Add max pooling layer

    conv_2 = Conv1D(500, 7, 2, padding=padding, activation="relu", name="conv_2")(max_pool_1)
    max_pool_2 = MaxPooling1D(pool_size=2, name="max_pool_2")(conv_2)  # Add max pooling layer

    conv_3 = Conv1D(500, 1, 1, padding=padding, activation="relu", name="conv_3")(max_pool_2)
    max_pool_3 = MaxPooling1D(pool_size=2, name="max_pool_3")(conv_3)  # Add max pooling layer

    conv_4 = Conv1D(3000, 1, 1, padding=padding, activation="relu", name="conv_4")(max_pool_3)
